            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-8 text-sm">
              <div>
                ...
                <div className="flex gap-3 mt-3">
                  <a href="https://instagram.com/rsouq" target="_blank" rel="noopener noreferrer" aria-label="Instagram"
                  ...
                  <a href="https://twitter.com/rsouq" target="_blank" rel="noopener noreferrer" aria-label="Twitter X"
                    className="w-8 h-8 rounded-full flex items-center justify-center bg-black transition hover:opacity-80">
                    <svg className="w-4 h-4 fill-white" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.748l7.73-8.835L1.254 2.25H8.08l4.259 5.63zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                  </a>
                  <a href="https://tiktok.com/@rsouq" target="_blank" rel="noopener noreferrer" aria-label="TikTok"
                    className="w-8 h-8 rounded-full flex items-center justify-center bg-black transition hover:opacity-80">
